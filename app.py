...
if st.button("Submit"):
    ...
    input_numerical = np.array([Age, D3Dimer, D5Dimer, Differentiation,FDP, PLT, PrevWF, Operationtime, Aanticoagulation, Lymphocyte,  vWFD3]).reshape(1, -1)
    feature_names  = ["Age", "D3Dimer", "D5Dimer","Differentiation","FDP","PLT","PrevWF","Operationtime","Aanticoagulation","Lymphocyte","vWFD1","vWFD3"]
